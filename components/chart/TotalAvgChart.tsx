...
import { BarProps } from "chart.js/dist/elements/element.bar";
...
export default function BarTest({ chartData }: IBarChart) {
...
if(!data)
    setData({
      ...
      <h2 style={{ textAlign: "center" }}>Total avg. Bar Chart</h2>
          {data &&
            <Bar
              data={data}
              options={{
