...
export default function BarChart({ chartData }: IBarChart) {
  ...
  function changeSelect(target: React.ChangeEvent<HTMLSelectElement>) {
    ...
    fagGrafArray.push(targetFag)
    console.log(fagGrafArray)
    
  let statsToShow = chartData.filter((o) => o.FAG == targetFag)
    unique = unique.filter(e => e !== targetFag)
    console.log(unique)
